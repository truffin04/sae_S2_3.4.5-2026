...
def auth_login_post():
    ...
    sql = '''SELECT utilisateur.id_utilisateur,utilisateur.login,utilisateur.password, utilisateur.role FROM utilisateur
            WHERE utilisateur.login = %s '''
...
def auth_signup_post():
    ...
    sql = '''SELECT utilisateur.login,utilisateur.email from utilisateur 
            WHERE utilisateur.login = %s OR utilisateur.email = %s '''
